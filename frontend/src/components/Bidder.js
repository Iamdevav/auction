                    ...
                    : auctions[auctions.length - 1].status !== "pending"
                      ...
                      : bidders[bidders.length - 1]?.name === bidderName
                        ...
                        : bidders.filter(
                          ...
                          ? "Accepting Bids"
                          : bidders.filter(data => data.auction_id === auctions[auctions.length - 1].id).map((bid) => (
                            bid.name === bidders[bidders.length - 1]?.name ? "Accepting Bids" : "You are NOT the highest bidder, Bid again to get back in!"
                          ))}
                </Form.Label>
                <hr />
                {bidders[bidders.length - 1]?.auction_id ===
